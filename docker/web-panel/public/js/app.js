...
const GIVE_ITEMS = {
  ...
  mining: [
    ...
    // Resources
    { label: 'Hardwood',          id: '(O)709' },
    { label: 'Wood',              id: '(O)388' },
    { label: 'Stone',             id: '(O)390' },
    { label: 'Clay',              id: '(O)330' },
    { label: 'Battery Pack',      id: '(O)787' },
    { label: 'Dragon Tooth',      id: '(O)852' },
    { label: 'Bone Fragment',     id: '(O)881' },
    { label: 'Calico Egg',        id: '(O)CalicoEgg' },
    // Minerals (museum)
    { label: 'Alamite',           id: '(O)538' },
    { label: 'Bixite',            id: '(O)539' },
    { label: 'Baryte',            id: '(O)540' },
    { label: 'Aerinite',          id: '(O)541' },
    { label: 'Calcite',           id: '(O)542' },
    { label: 'Dolomite',          id: '(O)543' },
    { label: 'Esperite',          id: '(O)544' },
    { label: 'Fluorapatite',      id: '(O)545' },
    { label: 'Geminite',          id: '(O)546' },
    { label: 'Helvite',           id: '(O)547' },
    { label: 'Jamborite',         id: '(O)548' },
    { label: 'Jagoite',           id: '(O)549' },
    { label: 'Kyanite',           id: '(O)550' },
    { label: 'Lunarite',          id: '(O)551' },
    { label: 'Malachite',         id: '(O)552' },
    { label: 'Neptunite',         id: '(O)553' },
    { label: 'Lemon Stone',       id: '(O)554' },
    { label: 'Nekoite',           id: '(O)555' },
    { label: 'Orpiment',          id: '(O)556' },
    { label: 'Petrified Slime',   id: '(O)557' },
    { label: 'Thunder Egg',       id: '(O)558' },
    { label: 'Pyrite',            id: '(O)559' },
    { label: 'Ocean Stone',       id: '(O)560' },
    { label: 'Ghost Crystal',     id: '(O)561' },
    { label: 'Tigerseye',         id: '(O)562' },
    { label: 'Jasper',            id: '(O)563' },
    { label: 'Opal',              id: '(O)564' },
    { label: 'Fire Opal',         id: '(O)565' },
    { label: 'Celestine',         id: '(O)566' },
    { label: 'Marble',            id: '(O)567' },
    { label: 'Sandstone',         id: '(O)568' },
    { label: 'Granite',           id: '(O)569' },
    { label: 'Basalt',            id: '(O)570' },
    { label: 'Limestone',         id: '(O)571' },
    { label: 'Soapstone',         id: '(O)572' },
    { label: 'Hematite',          id: '(O)573' },
    { label: 'Mudstone',          id: '(O)574' },
    { label: 'Obsidian',          id: '(O)575' },
    { label: 'Slate',             id: '(O)576' },
    { label: 'Fairy Stone',       id: '(O)577' },
    { label: 'Star Shards',       id: '(O)578' },
  ],
  farming: [
    // Spring crops
    { label: 'Parsnip',           id: '(O)24' },
    { label: 'Green Bean',        id: '(O)188' },
    { label: 'Cauliflower',       id: '(O)190' },
    { label: 'Potato',            id: '(O)192' },
    { label: 'Garlic',            id: '(O)248' },
    { label: 'Kale',              id: '(O)250' },
    { label: 'Rhubarb',           id: '(O)252' },
    { label: 'Strawberry',        id: '(O)400' },
    { label: 'Coffee Bean',       id: '(O)433' },
    // Summer crops
    { label: 'Melon',             id: '(O)254' },
    { label: 'Tomato',            id: '(O)256' },
    { label: 'Blueberry',         id: '(O)258' },
    { label: 'Hot Pepper',        id: '(O)260' },
    { label: 'Wheat',             id: '(O)262' },
    { label: 'Radish',            id: '(O)264' },
    { label: 'Starfruit',         id: '(O)268' },
    { label: 'Corn',              id: '(O)270' },
    { label: 'Hops',              id: '(O)304' },
    { label: 'Sunflower',         id: '(O)421' },
    // Fall crops
    { label: 'Pumpkin',           id: '(O)276' },
    { label: 'Yam',               id: '(O)280' },
    { label: 'Bok Choy',          id: '(O)278' },
    { label: 'Amaranth',          id: '(O)300' },
    { label: 'Grape',             id: '(O)398' },
    { label: 'Cranberries',       id: '(O)282' },
    { label: 'Beet',              id: '(O)284' },
    { label: 'Red Cabbage',       id: '(O)266' },
    { label: 'Eggplant',          id: '(O)272' },
    { label: 'Artichoke',         id: '(O)274' },
    { label: 'Sweet Gem Berry',   id: '(O)417' },
    { label: 'Ancient Fruit',     id: '(O)454' },
    // Island crops
    { label: 'Banana',            id: '(O)91' },
    { label: 'Pineapple',         id: '(O)832' },
    { label: 'Taro Root',         id: '(O)830' },
    { label: 'Ginger',            id: '(O)829' },
    { label: 'Mango',             id: '(O)834' },
    { label: 'Powdermelon',       id: '(O)Powdermelon' },
    // Forage
    { label: 'Wild Horseradish',  id: '(O)16' },
    { label: 'Daffodil',          id: '(O)18' },
    { label: 'Leek',              id: '(O)20' },
    { label: 'Dandelion',         id: '(O)22' },
    { label: 'Spring Onion',      id: '(O)399' },
    { label: 'Salmonberry',       id: '(O)296' },
    { label: 'Coconut',           id: '(O)88' },
    { label: 'Cactus Fruit',      id: '(O)90' },
    { label: 'Spice Berry',       id: '(O)396' },
    { label: 'Sweet Pea',         id: '(O)402' },
    { label: 'Fiddlehead Fern',   id: '(O)259' },
    { label: 'Wild Plum',         id: '(O)406' },
    { label: 'Hazelnut',          id: '(O)408' },
    { label: 'Blackberry',        id: '(O)410' },
    { label: 'Winter Root',       id: '(O)412' },
    { label: 'Crystal Fruit',     id: '(O)414' },
    { label: 'Snow Yam',          id: '(O)416' },
    { label: 'Crocus',            id: '(O)418' },
    { label: 'Holly',             id: '(O)283' },
    { label: 'Chanterelle',       id: '(O)281' },
    { label: 'Common Mushroom',   id: '(O)404' },
    { label: 'Morel',             id: '(O)257' },
    { label: 'Red Mushroom',      id: '(O)420' },
    { label: 'Purple Mushroom',   id: '(O)422' },
    { label: 'Magma Cap',         id: '(O)851' },
    // Tree fruits
    { label: 'Apple',             id: '(O)613' },
    { label: 'Cherry',            id: '(O)638' },
    { label: 'Apricot',           id: '(O)634' },
    { label: 'Orange',            id: '(O)635' },
    { label: 'Peach',             id: '(O)636' },
    { label: 'Pomegranate',       id: '(O)637' },
    { label: 'Tea Leaves',        id: '(O)814' },
    // Tree products
    { label: 'Maple Syrup',       id: '(O)724' },
    { label: 'Oak Resin',         id: '(O)725' },
    { label: 'Pine Tar',          id: '(O)726' },
    // Animal products
    { label: 'Egg (White)',        id: '(O)176' },
    { label: 'Egg (Brown)',        id: '(O)180' },
    { label: 'Large Egg (White)', id: '(O)174' },
    { label: 'Large Egg (Brown)', id: '(O)182' },
    { label: 'Milk',              id: '(O)184' },
    { label: 'Large Milk',        id: '(O)186' },
    { label: 'Goat Milk',         id: '(O)436' },
    { label: 'L. Goat Milk',      id: '(O)438' },
    { label: 'Duck Egg',          id: '(O)442' },
    { label: 'Duck Feather',      id: '(O)444' },
    { label: 'Rabbit\'s Foot',    id: '(O)447' },
    { label: 'Truffle',           id: '(O)430' },
    { label: 'Truffle Oil',       id: '(O)432' },
    { label: 'Wool',              id: '(O)440' },
    { label: 'Mayonnaise',        id: '(O)306' },
    { label: 'Duck Mayonnaise',   id: '(O)307' },
    { label: 'Void Mayonnaise',   id: '(O)308' },
    { label: 'Cheese',            id: '(O)424' },
    { label: 'Goat Cheese',       id: '(O)426' },
    { label: 'Cloth',             id: '(O)428' },
    { label: 'Ostrich Egg',       id: '(O)289' },
    { label: 'Iridium Milk',      id: '(O)803' },
    { label: 'Void Egg',          id: '(O)305' },
    { label: 'Golden Egg',        id: '(O)928' },
    { label: 'Dinosaur Egg',      id: '(O)107' },
    // Special farm items
    { label: 'Golden Walnut',     id: '(O)73' },
    { label: 'Golden Pumpkin',    id: '(O)373' },
    ...
    { label: 'Hay',               id: '(O)178' },
    { label: 'Fiber',             id: '(O)771' },
  ],
  seeds: [
    // Spring seeds
    { label: 'Parsnip Seeds',       id: '(O)472' },
    { label: 'Bean Starter',        id: '(O)473' },
    { label: 'Cauliflower Seeds',   id: '(O)474' },
    { label: 'Potato Seeds',        id: '(O)475' },
    { label: 'Garlic Seeds',        id: '(O)476' },
    { label: 'Kale Seeds',          id: '(O)477' },
    { label: 'Rhubarb Seeds',       id: '(O)478' },
    { label: 'Strawberry Seeds',    id: '(O)745' },
    { label: 'Tulip Bulb',          id: '(O)427' },
    { label: 'Jazz Seeds',          id: '(O)429' },
    // Summer seeds
    { label: 'Melon Seeds',         id: '(O)479' },
    { label: 'Tomato Seeds',        id: '(O)480' },
    { label: 'Blueberry Seeds',     id: '(O)481' },
    { label: 'Pepper Seeds',        id: '(O)482' },
    { label: 'Wheat Seeds',         id: '(O)483' },
    { label: 'Radish Seeds',        id: '(O)484' },
    { label: 'Starfruit Seeds',     id: '(O)486' },
    { label: 'Corn Seeds',          id: '(O)487' },
    { label: 'Hops Starter',        id: '(O)302' },
    { label: 'Poppy Seeds',         id: '(O)453' },
    { label: 'Sunflower Seeds',     id: '(O)431' },
    { label: 'Spangle Seeds',       id: '(O)455' },
    // Fall seeds
    { label: 'Pumpkin Seeds',       id: '(O)490' },
    { label: 'Yam Seeds',           id: '(O)492' },
    { label: 'Bok Choy Seeds',      id: '(O)491' },
    { label: 'Amaranth Seeds',      id: '(O)299' },
    { label: 'Grape Starter',       id: '(O)301' },
    { label: 'Cranberry Seeds',     id: '(O)493' },
    { label: 'Beet Seeds',          id: '(O)494' },
    { label: 'Red Cabbage Seeds',   id: '(O)485' },
    { label: 'Eggplant Seeds',      id: '(O)488' },
    { label: 'Artichoke Seeds',     id: '(O)489' },
    { label: 'Fairy Seeds',         id: '(O)425' },
    // Multi-season
    { label: 'Rice Shoot',          id: '(O)273' },
    // Island seeds
    { label: 'Pineapple Seeds',     id: '(O)833' },
    { label: 'Taro Tuber',          id: '(O)831' },
    { label: 'Cactus Seeds',        id: '(O)802' },
    { label: 'Carrot Seeds',        id: '(O)CarrotSeeds' },
    // Special seeds
    { label: 'Ancient Seeds',       id: '(O)499' },
    { label: 'Rare Seed',           id: '(O)347' },
    { label: 'Mahogany Seed',       id: '(O)292' },
    { label: 'Mystic Tree Seed',    id: '(O)MysticTreeSeed' },
    { label: 'Mushroom Tree Seed',  id: '(O)891' },
    { label: 'Fiber Seeds',         id: '(O)885' },
    { label: 'Mixed Seeds',         id: '(O)770' },
    { label: 'Mixed Flower Seeds',  id: '(O)MixedFlowerSeeds' },
    { label: 'Spring Seeds',        id: '(O)495' },
    { label: 'Summer Seeds',        id: '(O)496' },
    { label: 'Fall Seeds',          id: '(O)497' },
    { label: 'Winter Seeds',        id: '(O)498' },
    { label: 'Qi Bean',             id: '(O)890' },
    // Saplings
    { label: 'Cherry Sapling',      id: '(O)628' },
    { label: 'Apricot Sapling',     id: '(O)629' },
    { label: 'Orange Sapling',      id: '(O)630' },
    { label: 'Peach Sapling',       id: '(O)631' },
    { label: 'Pomegranate Sapling', id: '(O)632' },
    { label: 'Apple Sapling',       id: '(O)633' },
    { label: 'Banana Sapling',      id: '(O)69' },
    { label: 'Mango Sapling',       id: '(O)835' },
    { label: 'Tea Sapling',         id: '(O)251' },
    // Fertilizers
    { label: 'Basic Fertilizer',      id: '(O)368' },
    { label: 'Quality Fertilizer',    id: '(O)369' },
    { label: 'Deluxe Fertilizer',     id: '(O)919' },
    { label: 'Basic Retaining Soil',  id: '(O)370' },
    { label: 'Quality Retaining Soil',id: '(O)371' },
    { label: 'Deluxe Retaining Soil', id: '(O)920' },
    { label: 'Speed-Gro',             id: '(O)465' },
    { label: 'Deluxe Speed-Gro',      id: '(O)466' },
    { label: 'Hyper Speed-Gro',       id: '(O)918' },
    { label: 'Tree Fertilizer',       id: '(O)805' },
    { label: 'Grass Starter',         id: '(O)297' },
    { label: 'Blue Grass Starter',    id: '(O)Blue Grass Starter' },
  ],
  fishing: [
    // Standard fish
    { label: 'Pufferfish',       id: '(O)128' },
    { label: 'Anchovy',          id: '(O)129' },
    { label: 'Tuna',             id: '(O)130' },
    { label: 'Sardine',          id: '(O)131' },
    { label: 'Bream',            id: '(O)132' },
    { label: 'Largemouth Bass',  id: '(O)136' },
    { label: 'Smallmouth Bass',  id: '(O)137' },
    { label: 'Rainbow Trout',    id: '(O)138' },
    { label: 'Salmon',           id: '(O)139' },
    { label: 'Walleye',          id: '(O)140' },
    { label: 'Perch',            id: '(O)141' },
    { label: 'Carp',             id: '(O)142' },
    { label: 'Catfish',          id: '(O)143' },
    { label: 'Pike',             id: '(O)144' },
    { label: 'Sunfish',          id: '(O)145' },
    { label: 'Red Mullet',       id: '(O)146' },
    { label: 'Herring',          id: '(O)147' },
    { label: 'Eel',              id: '(O)148' },
    { label: 'Octopus',          id: '(O)149' },
    { label: 'Red Snapper',      id: '(O)150' },
    { label: 'Squid',            id: '(O)151' },
    { label: 'Sea Cucumber',     id: '(O)154' },
    { label: 'Super Cucumber',   id: '(O)155' },
    { label: 'Ghostfish',        id: '(O)156' },
    { label: 'Stonefish',        id: '(O)158' },
    { label: 'Crimsonfish',      id: '(O)159' },
    { label: 'Angler',           id: '(O)160' },
    { label: 'Ice Pip',          id: '(O)161' },
    { label: 'Lava Eel',         id: '(O)162' },
    { label: 'Legend',           id: '(O)163' },
    { label: 'Sandfish',         id: '(O)164' },
    { label: 'Scorpion Carp',    id: '(O)165' },
    { label: 'Flounder',         id: '(O)267' },
    { label: 'Midnight Carp',    id: '(O)269' },
    { label: 'Woodskip',         id: '(O)734' },
    { label: 'Sturgeon',         id: '(O)698' },
    { label: 'Tiger Trout',      id: '(O)699' },
    { label: 'Bullhead',         id: '(O)700' },
    { label: 'Tilapia',          id: '(O)701' },
    { label: 'Chub',             id: '(O)702' },
    { label: 'Dorado',           id: '(O)704' },
    { label: 'Albacore',         id: '(O)705' },
    { label: 'Shad',             id: '(O)706' },
    { label: 'Lingcod',          id: '(O)707' },
    { label: 'Halibut',          id: '(O)708' },
    { label: 'Void Salmon',      id: '(O)795' },
    { label: 'Slimejack',        id: '(O)796' },
    { label: 'Midnight Squid',   id: '(O)798' },
    { label: 'Spook Fish',       id: '(O)799' },
    { label: 'Blobfish',         id: '(O)800' },
    { label: 'Stingray',         id: '(O)836' },
    { label: 'Lionfish',         id: '(O)837' },
    { label: 'Blue Discus',      id: '(O)838' },
    { label: 'Mutant Carp',      id: '(O)682' },
    { label: 'Glacierfish',      id: '(O)775' },
    { label: 'Goby',             id: '(O)Goby' },
    // Legendary II
    { label: 'Son of Crimsonfish',id: '(O)898' },
    { label: 'Ms. Angler',       id: '(O)899' },
    { label: 'Legend II',        id: '(O)900' },
    { label: 'Radioactive Carp', id: '(O)901' },
    { label: 'Glacierfish Jr.',  id: '(O)902' },
    // Crab pot
    { label: 'Lobster',          id: '(O)715' },
    { label: 'Crayfish',         id: '(O)716' },
    { label: 'Crab',             id: '(O)717' },
    { label: 'Cockle',           id: '(O)718' },
    { label: 'Mussel',           id: '(O)719' },
    { label: 'Shrimp',           id: '(O)720' },
    { label: 'Snail',            id: '(O)721' },
    { label: 'Periwinkle',       id: '(O)722' },
    { label: 'Oyster',           id: '(O)723' },
    { label: 'Clam',             id: '(O)372' },
    // Ocean forage
    { label: 'Coral',            id: '(O)393' },
    { label: 'Sea Urchin',       id: '(O)397' },
    { label: 'Rainbow Shell',    id: '(O)394' },
    { label: 'Nautilus Shell',   id: '(O)392' },
    { label: 'Seaweed',          id: '(O)152' },
    { label: 'Green Algae',      id: '(O)153' },
    // Bait & tackle
    { label: 'Bait',             id: '(O)685' },
    { label: 'Deluxe Bait',      id: '(O)DeluxeBait' },
    { label: 'Challenge Bait',   id: '(O)ChallengeBait' },
    { label: 'Wild Bait',        id: '(O)774' },
    { label: 'Magic Bait',       id: '(O)908' },
    { label: 'Spinner',          id: '(O)686' },
    { label: 'Dressed Spinner',  id: '(O)687' },
    { label: 'Barbed Hook',      id: '(O)691' },
    { label: 'Lead Bobber',      id: '(O)692' },
    { label: 'Treasure Hunter',  id: '(O)693' },
    { label: 'Trap Bobber',      id: '(O)694' },
    { label: 'Cork Bobber',      id: '(O)695' },
    { label: 'Curiosity Lure',   id: '(O)856' },
    { label: 'Quality Bobber',   id: '(O)877' },
    { label: 'Golden Bobber',    id: '(O)GoldenBobber' },
    { label: 'Sonar Bobber',     id: '(O)SonarBobber' },
    { label: 'Magnet',           id: '(O)703' },
    { label: 'Golden Tag',       id: '(O)TroutDerbyTag' },
    { label: 'Crab Pot',         id: '(O)710' },
    // Fish products
    { label: 'Roe',              id: '(O)812' },
    { label: 'Aged Roe',         id: '(O)446' },
    { label: 'Caviar',           id: '(O)445' },
    { label: 'Squid Ink',        id: '(O)814' },
    { label: 'Pearl',            id: '(O)797' },
  ...
  food: [
    { label: 'Fried Egg',          id: '(O)194' },
    { label: 'Omelet',             id: '(O)195' },
    { label: 'Salad',              id: '(O)196' },
    { label: 'Cheese Cauliflower', id: '(O)197' },
    { label: 'Baked Fish',         id: '(O)198' },
    { label: 'Parsnip Soup',       id: '(O)199' },
    { label: 'Vegetable Medley',   id: '(O)200' },
    { label: 'Complete Breakfast', id: '(O)201' },
    { label: 'Fried Calamari',     id: '(O)202' },
    { label: 'Strange Bun',        id: '(O)203' },
    { label: 'Lucky Lunch',        id: '(O)204' },
    { label: 'Fried Mushroom',     id: '(O)205' },
    { label: 'Pizza',              id: '(O)206' },
    { label: 'Bean Hotpot',        id: '(O)207' },
    { label: 'Glazed Yams',        id: '(O)208' },
    { label: 'Carp Surprise',      id: '(O)209' },
    { label: 'Hashbrowns',         id: '(O)210' },
    { label: 'Pancakes',           id: '(O)211' },
    { label: 'Salmon Dinner',      id: '(O)212' },
    { label: 'Fish Taco',          id: '(O)213' },
    { label: 'Crispy Bass',        id: '(O)214' },
    { label: 'Pepper Poppers',     id: '(O)215' },
    { label: 'Bread',              id: '(O)216' },
    { label: 'Tom Kha Soup',       id: '(O)218' },
    { label: 'Trout Soup',         id: '(O)219' },
    { label: 'Chocolate Cake',     id: '(O)220' },
    { label: 'Pink Cake',          id: '(O)221' },
    { label: 'Rhubarb Pie',        id: '(O)222' },
    { label: 'Cookie',             id: '(O)223' },
    { label: 'Spaghetti',          id: '(O)224' },
    { label: 'Fried Eel',          id: '(O)225' },
    { label: 'Spicy Eel',          id: '(O)226' },
    { label: 'Sashimi',            id: '(O)227' },
    { label: 'Maki Roll',          id: '(O)228' },
    { label: 'Tortilla',           id: '(O)229' },
    { label: 'Red Plate',          id: '(O)230' },
    { label: 'Eggplant Parmesan',  id: '(O)231' },
    { label: 'Rice Pudding',       id: '(O)232' },
    { label: 'Ice Cream',          id: '(O)233' },
    { label: 'Blueberry Tart',     id: '(O)234' },
    { label: 'Autumn\'s Bounty',   id: '(O)235' },
    { label: 'Pumpkin Soup',       id: '(O)236' },
    { label: 'Super Meal',         id: '(O)237' },
    { label: 'Cranberry Sauce',    id: '(O)238' },
    { label: 'Stuffing',           id: '(O)239' },
    { label: 'Farmer\'s Lunch',    id: '(O)240' },
    { label: 'Survival Burger',    id: '(O)241' },
    { label: 'Dish O\' The Sea',   id: '(O)242' },
    { label: 'Miner\'s Treat',     id: '(O)243' },
    { label: 'Roots Platter',      id: '(O)244' },
    { label: 'Seafoam Pudding',    id: '(O)265' },
    { label: 'Algae Soup',         id: '(O)456' },
    { label: 'Pale Broth',         id: '(O)457' },
    { label: 'Triple Shot Espresso',id: '(O)253' },
    { label: 'Plum Pudding',       id: '(O)604' },
    { label: 'Artichoke Dip',      id: '(O)605' },
    { label: 'Stir Fry',           id: '(O)606' },
    { label: 'Roasted Hazelnuts',  id: '(O)607' },
    { label: 'Pumpkin Pie',        id: '(O)608' },
    { label: 'Radish Salad',       id: '(O)609' },
    { label: 'Fruit Salad',        id: '(O)610' },
    { label: 'Blackberry Cobbler', id: '(O)611' },
    { label: 'Cranberry Candy',    id: '(O)612' },
    { label: 'Bruschetta',         id: '(O)618' },
    { label: 'Coleslaw',           id: '(O)648' },
    { label: 'Fiddlehead Risotto', id: '(O)649' },
    { label: 'Poppyseed Muffin',   id: '(O)651' },
    { label: 'Chowder',            id: '(O)727' },
    { label: 'Fish Stew',          id: '(O)728' },
    { label: 'Escargot',           id: '(O)729' },
    { label: 'Lobster Bisque',     id: '(O)730' },
    { label: 'Maple Bar',          id: '(O)731' },
    { label: 'Crab Cakes',         id: '(O)732' },
    { label: 'Shrimp Cocktail',    id: '(O)733' },
    { label: 'Ginger Ale',         id: '(O)903' },
    { label: 'Banana Pudding',     id: '(O)904' },
    { label: 'Mango Sticky Rice',  id: '(O)905' },
    { label: 'Poi',                id: '(O)906' },
    { label: 'Tropical Curry',     id: '(O)907' },
    { label: 'Squid Ink Ravioli',  id: '(O)921' },
    { label: 'Piña Colada',        id: '(O)873' },
    { label: 'Bug Steak',          id: '(O)874' },
    { label: 'Coffee',             id: '(O)395' },
    { label: 'Beer',               id: '(O)346' },
    { label: 'Pale Ale',           id: '(O)303' },
    { label: 'Mead',               id: '(O)459' },
    { label: 'Wine',               id: '(O)348' },
    { label: 'Juice',              id: '(O)350' },
    { label: 'Pickles',            id: '(O)342' },
    { label: 'Jelly',              id: '(O)344' },
    { label: 'Honey',              id: '(O)340' },
    { label: 'Field Snack',        id: '(O)403' },
    { label: 'Magic Rock Candy',   id: '(O)279' },
    { label: 'Stardrop Tea',       id: '(O)Stardrop Tea' },
    { label: 'Energy Tonic',       id: '(O)349' },
    { label: 'Muscle Remedy',      id: '(O)351' },
    { label: 'Life Elixir',        id: '(O)773' },
    { label: 'Oil of Garlic',      id: '(O)772' },
  ],
  rings: [
    { label: 'Iridium Band',       id: '(O)527' },
    { label: 'Glow Ring',          id: '(O)517' },
    { label: 'Small Glow Ring',    id: '(O)516' },
    { label: 'Magnet Ring',        id: '(O)519' },
    { label: 'Small Magnet Ring',  id: '(O)518' },
    { label: 'Slime Charmer Ring', id: '(O)520' },
    { label: 'Warrior Ring',       id: '(O)521' },
    { label: 'Vampire Ring',       id: '(O)522' },
    { label: 'Savage Ring',        id: '(O)523' },
    { label: 'Ring of Yoba',       id: '(O)524' },
    { label: 'Sturdy Ring',        id: '(O)525' },
    { label: 'Burglar\'s Ring',    id: '(O)526' },
    { label: 'Jukebox Ring',       id: '(O)528' },
    { label: 'Amethyst Ring',      id: '(O)529' },
    { label: 'Topaz Ring',         id: '(O)530' },
    { label: 'Aquamarine Ring',    id: '(O)531' },
    { label: 'Jade Ring',          id: '(O)532' },
    { label: 'Emerald Ring',       id: '(O)533' },
    { label: 'Ruby Ring',          id: '(O)534' },
    { label: 'Thorns Ring',        id: '(O)839' },
    { label: 'Lucky Ring',         id: '(O)859' },
    { label: 'Hot Java Ring',      id: '(O)860' },
    { label: 'Protection Ring',    id: '(O)861' },
    { label: 'Soul Sapper Ring',   id: '(O)862' },
    { label: 'Phoenix Ring',       id: '(O)863' },
    { label: 'Immunity Band',      id: '(O)887' },
    { label: 'Glowstone Ring',     id: '(O)888' },
    { label: 'Crabshell Ring',     id: '(O)810' },
    { label: 'Combined Ring',      id: '(O)880' },
  ],
  artifacts: [
    // Artifacts
    { label: 'Chipped Amphora',       id: '(O)100' },
    { label: 'Arrowhead',             id: '(O)101' },
    { label: 'Ancient Doll',          id: '(O)103' },
    { label: 'Elvish Jewelry',        id: '(O)104' },
    { label: 'Chewing Stick',         id: '(O)105' },
    { label: 'Ornamental Fan',        id: '(O)106' },
    { label: 'Rare Disc',             id: '(O)108' },
    { label: 'Ancient Sword',         id: '(O)109' },
    { label: 'Rusty Spoon',           id: '(O)110' },
    { label: 'Rusty Spur',            id: '(O)111' },
    { label: 'Rusty Cog',             id: '(O)112' },
    { label: 'Chicken Statue',        id: '(O)113' },
    { label: 'Ancient Seed',          id: '(O)114' },
    { label: 'Prehistoric Tool',      id: '(O)115' },
    { label: 'Dried Starfish',        id: '(O)116' },
    { label: 'Anchor',                id: '(O)117' },
    { label: 'Glass Shards',          id: '(O)118' },
    { label: 'Bone Flute',            id: '(O)119' },
    { label: 'Prehistoric Handaxe',   id: '(O)120' },
    { label: 'Dwarvish Helm',         id: '(O)121' },
    { label: 'Dwarf Gadget',          id: '(O)122' },
    { label: 'Ancient Drum',          id: '(O)123' },
    { label: 'Golden Mask',           id: '(O)124' },
    { label: 'Golden Relic',          id: '(O)125' },
    { label: 'Strange Doll (Yellow)', id: '(O)126' },
    { label: 'Strange Doll (Green)',  id: '(O)127' },
    { label: 'Dwarf Scroll I',        id: '(O)96' },
    { label: 'Dwarf Scroll II',       id: '(O)97' },
    { label: 'Dwarf Scroll III',      id: '(O)98' },
    { label: 'Dwarf Scroll IV',       id: '(O)99' },
    // Fossils
    { label: 'Prehistoric Scapula',   id: '(O)579' },
    { label: 'Prehistoric Tibia',     id: '(O)580' },
    { label: 'Prehistoric Skull',     id: '(O)581' },
    { label: 'Skeletal Hand',         id: '(O)582' },
    { label: 'Prehistoric Rib',       id: '(O)583' },
    { label: 'Prehistoric Vertebra',  id: '(O)584' },
    { label: 'Skeletal Tail',         id: '(O)585' },
    { label: 'Nautilus Fossil',       id: '(O)586' },
    { label: 'Amphibian Fossil',      id: '(O)587' },
    { label: 'Palm Fossil',           id: '(O)588' },
    { label: 'Trilobite',             id: '(O)589' },
    // Island fossils
    { label: 'Fossilized Skull',      id: '(O)820' },
    { label: 'Fossilized Spine',      id: '(O)821' },
    { label: 'Fossilized Leg',        id: '(O)823' },
    { label: 'Fossilized Ribs',       id: '(O)824' },
    { label: 'Snake Skull',           id: '(O)825' },
    { label: 'Snake Vertebrae',       id: '(O)826' },
    { label: 'Mummified Bat',         id: '(O)827' },
    { label: 'Mummified Frog',        id: '(O)828' },
    // Misc museum
    { label: 'Artifact Trove',        id: '(O)275' },
    { label: 'Dwarvish Translation Guide', id: '(O)326' },
    { label: 'Journal Scrap',         id: '(O)842' },
    { label: 'Secret Note',           id: '(O)79' },
  ],
  misc: [
    // Warp totems
    { label: 'Warp Totem: Farm',       id: '(O)688' },
    { label: 'Warp Totem: Mountains',  id: '(O)689' },
    { label: 'Warp Totem: Beach',      id: '(O)690' },
    { label: 'Warp Totem: Island',     id: '(O)886' },
    { label: 'Warp Totem: Desert',     id: '(O)261' },
    { label: 'Warp Totem: Qi\'s Arena',id: '(O)892' },
    { label: 'Rain Totem',             id: '(O)681' },
    { label: 'Treasure Totem',         id: '(O)Treasure Totem' },
    { label: 'Horse Flute',            id: '(O)911' },
    // Bombs
    { label: 'Cherry Bomb',            id: '(O)286' },
    { label: 'Bomb',                   id: '(O)287' },
    { label: 'Mega Bomb',              id: '(O)288' },
    // Combat drops
    { label: 'Slime',                  id: '(O)766' },
    { label: 'Bat Wing',               id: '(O)767' },
    { label: 'Solar Essence',          id: '(O)768' },
    { label: 'Void Essence',           id: '(O)769' },
    { label: 'Bug Meat',               id: '(O)684' },
    { label: 'Ectoplasm',              id: '(O)875' },
    { label: 'Monster Musk',           id: '(O)879' },
    { label: 'Explosive Ammo',         id: '(O)441' },
    { label: 'Blue Slime Egg',         id: '(O)413' },
    { label: 'Red Slime Egg',          id: '(O)437' },
    { label: 'Purple Slime Egg',       id: '(O)439' },
    { label: 'Green Slime Egg',        id: '(O)680' },
    { label: 'Tiger Slime Egg',        id: '(O)857' },
    // Special / unique
    { label: 'Golden Animal Cracker',  id: '(O)Golden Animal Cracker' },
    ...
    { label: 'Golden Pumpkin',         id: '(O)373' },
    { label: 'Ornate Necklace',        id: '(O)191' },
    { label: 'Galaxy Soul',            id: '(O)896' },
    { label: 'Qi Gem',                 id: '(O)858' },
    { label: 'Qi Fruit',               id: '(O)889' },
    { label: 'Qi Seasoning',           id: '(O)917' },
    { label: 'Prismatic Jelly',        id: '(O)876' },
    { label: 'Pierre\'s Missing Stocklist', id: '(O)897' },
    { label: 'Fireworks (Red)',         id: '(O)893' },
    { label: 'Fireworks (Purple)',      id: '(O)894' },
    { label: 'Fireworks (Green)',       id: '(O)895' },
    { label: 'Calico Egg',             id: '(O)CalicoEgg' },
    { label: 'Cookout Kit',            id: '(O)926' },
    { label: 'Camping Stove',          id: '(O)927' },
    { label: 'Sprinkler',              id: '(O)599' },
    { label: 'Quality Sprinkler',      id: '(O)621' },
    { label: 'Iridium Sprinkler',      id: '(O)645' },
    { label: 'Enricher',               id: '(O)913' },
    { label: 'Pressure Nozzle',        id: '(O)915' },
    { label: 'Bouquet',                id: '(O)458' },
    { label: 'Bouquet (Wilted)',        id: '(O)277' },
    { label: 'Mermaid\'s Pendant',     id: '(O)460' },
    { label: 'Wedding Ring',           id: '(O)801' },
    { label: 'Movie Ticket',           id: '(O)809' },
    { label: 'Lucky Purple Shorts',    id: '(O)789' },
    { label: 'Trimmed Lucky Purple Shorts', id: '(O)71' },
    { label: 'Joja Cola',              id: '(O)167' },
    { label: 'Jack-O-Lantern',         id: '(O)746' },
  ],
};
...
const _playersWithGiftChests = new Set();
